...
$pdf->SetAuthor('Jigsaw Innovation'); // ชื่อผู้สร้างไฟล์ PDF

//$pdf->SetTitle('USING HTML 2 PDF FROM TCPDF');//  กำหนด Title
$pdf->SetTitle('PDF Exportation');//  กำหนด Title
...
$fontname = TCPDF_FONTS::addTTFfont(APPPATH.'libraries/html2pdf/th_sarabun_psk/THSarabun.ttf', 'TrueTypeUnicode', '', 32);
$pdf->SetFont('THSarabun', '', 10);


/* Modified for this Job *Remove Header & Footer */
$pdf->SetPrintHeader(false);
$pdf->SetPrintFooter(false);
/* End Modified for this Job *Remove Header & Footer*/
