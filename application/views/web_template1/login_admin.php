                                                 ...
                                                 <div class="col-xs-12 col-sm-4 col-sm-offset-4 text-center">
                                                        <div class="row clearfix" style="border: 10px solid rgba(96, 125, 139, 0.71);background-color: rgba(240, 248, 255, 0.11);">
                                                            ...
                                                            <div class="col-xs-12 col-sm-10 col-sm-offset-1 text-center">
                                                                <button type="submit" class="btn btn-primary btn-lg"  name="bt_submit">เข้าสู่ระบบ</button>
                                                            </div>
                                 ...
                                 <!--  <div class="col-xs-12 col-sm-12">
                                     <div class="row">
                                         <div class="col-xs-12 col-sm-6 col-sm-offset-3 text-center">
                                           ...
                                           <a id="Older_Infornation" class="btn btn-default" href="<?php echo site_url('individual_authen/authen_info?id=null');?>" role="button" style="background-color: rgb(25, 43, 57); border: 3px solid rgba(238, 238, 238, 0.6); font-size: 18px;">ระบบให้บริการข้อมูลทะเบียนประวััติผู้สูงอายุแบบออนไลน์ <br>(Older Information Center)</a>
