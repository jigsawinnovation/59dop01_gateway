                          ...
                          <table id="dtable" class="table table-striped table-bordered table-hover dataTables-example" >
                            ...
                            <?php foreach ($info as $i => $value) { ?>
                              <tr>
                                <td class="lnk">
                                <?php 
                                  $arr = explode(' ',$value['req_datetime']);
                                  echo dateChange($arr[0],5).' '.$arr[1].'น.'; 
                                ?>
                                </td>
                                   ...
                                   <div class="modal-header" style="background-color: #eee">
                                    ...
                                    <div class="modal-body">
                                      <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8"><?php echo formatDateThai($arr[0]).' '.$arr[1].'น.';?></div>
                                      </div>
                                      <div class="row">
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                          <?php 
                                            //$tmp = unserialize($value['log_note']);
                                            if($value['result']=='Success' && isset($tmp['result'])) {
                                              echo @$tmp['result']['pid'];
                                            }else {
                                              echo @$tmp['result']['pid'].' Error code: '.@$tmp['result']['code'];
                                            }
