        ...
        <div class="panel panel-default" style="margin-top: -15px; border: 0">
            ...
            <div class="form-group row">
              ...
              <div class="col-xs-12 col-sm-12">
                ...
                <?php
                $i=1;
                foreach($exportwsv_info as $key=>$row) {
                ?>
                ...
                <div class="row panel-heading" style="padding-top: 0px;">
                  <h4 class="text-white" style="padding: 15px; background-color: #336666;//background-color: #3300CC; margin-top: 0px;">
                    ...
                    Export ข้อมูลจาก<?php echo $row['name'];?>
                  </h4>
                </div>
                <div class="panel-heading" style="margin-top: -30px;">
                  <div class="list-group">
                    ...
                    <!--
                      <div data-toggle="modal" data-target="#l<?php echo $row1['wsrv_id'];?>" class="col-xs-12 col-sm-10" style="padding-top: 10px"><button type="button" class="btn btn-warning btn-xs" disabled><i class="fa fa-cog" aria-hidden="true" style="color:#330000"></i></button>  <?php echo $row1['wsrv_definition'];?> (<?php echo $row1['wsrv_name'];?>)</div>
                    -->
                      ...
                      <div class="col-xs-12 col-sm-2 text-right">
                        ...
                        <a target="_blank" href="<?php echo site_url('transfer/export/structure/wsrv_id/'.$row1['wsrv_id']);?>" title="JSON">
                          <img src="<?php echo base_url('assets/images/json.png');?>" width="40px">
                        </a>
                        <a target="_blank" href="<?php echo site_url('transfer/export/structure/wsrv_id/'.$row1['wsrv_id'].'/format/xml');?>" title="XML">
                                ...
                                <div class="modal-header" style="background-color:#397879; color: #fff">
                                    ...
                                    Export ข้อมูลจาก<?php echo $row['name'];?>
                                      ...
                                      <div class="text-right" style="float: right; margin-right: 20px; margin-top: -6px;">
                                          <a target="_blank" href="<?php echo base_url('assets/file/webservice_export'.($i++).'.pdf');?>" style="background-color: #c40f15; color: #fff" class="btn"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>  Export PDF</a>   
                                          <!--
