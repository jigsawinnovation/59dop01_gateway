<script>
  var dtable_url = '<?php echo site_url('manage_transfer/statistic_exportlog_list');?>';
</script>

<div id="tmp_menu" hidden='hidden'>

  <a style="margin-left: 0px; background-color: #2f4250; border: 0;font-size: 17px; padding: 2px 20px 2px 20px;" title="ค้นหา" class="navbar-minimalize minimalize-styl-2 btn btn-primary" data-toggle="modal" data-target="#mySearch">
