...
<body>
            ...
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0; background: transparent !important;">
                ...
                <ul class="nav navbar-top-links navbar-right" style="margin: 0px; color: #fff !important">
                    ...
                    <li title="<?php echo $user;?>">
                        <a style="font-size: 18px;" href="#"> <span style="color: #fff !important" class="m-r-sm text-muted welcome-message"><?php echo $user;?></span> <?php if(get_session('licen')==''){ ?> <img src="<?php echo 'https://center.dop.go.th/'.get_session('user_photo_file');?>" class="profile img-circle border-1" style="border: 4px #eee solid;" alt="<?php echo $user;?>" width="42" height="42"> <?php } ?> 
                        </a>
                    </li>
                    ...
                    <li>
                        ...
                        <a title="ออกจากระบบ" href="<?php echo site_url('logout');?>" style="display: inline;">
        ...
        <div class="row" style="background: transparent !important;">
            <div class="container" style="min-height: 600px;">
               ...
               <div class="row permiss_head">
                    <div id="import" class="col-xs-12 col-sm-4 permiss_head-panel" style="border-right:0">
                        <br/>
                        <div class="row">
                    ...
                    <div id="export" class="col-xs-12 col-sm-4 permiss_head-panel" style="border-right:0">
                        <br/>
                        <div class="row">
                            <div class="col-sm-12 item">
                                <a 
                    ...
                    <div id="datastandard" class="col-xs-12 col-sm-4 permiss_head-panel" style="border-right:0">
                        <br/>
                        <div class="row">
                            <div class="col-sm-12 item">
                    ...
                    <div id="authen_key" class="col-xs-12 col-sm-4 permiss_head-panel" style="border-right:0">
                        <br/>
                        <div class="row">
                            <div class="col-sm-12 item">
                                <a 
                    ...
                    <div id="statistic_importlog" class="col-xs-12 col-sm-4 permiss_head-panel" style="border-right:0">
                        <br/>
                        <div class="row">
                            <div class="col-sm-12 item">
                    ...
                    <!--
                    <div id="webservice_demo" class="col-xs-12 col-sm-4 permiss_head-panel" style="border-right:0">
                        <br/>
                        <div class="row">
                            <div class="col-sm-12 item">
                                <a 
                    ...
                    -->
                    <div id="data_warehouse" class="col-xs-12 col-sm-4 permiss_head-panel" style="border-right:0">
                        <br/>
                        <div class="row">
                            <div class="col-sm-12 item">
                                <a 
                                ...
                                if(!isset($tmp1['perm_status'])) { ?>
                                     class="disabled" 
                                <?php }else{?>href="<?php echo site_url('manage_transfer/data_warehouse');?>"<?php }?>>
                                    <div class="col-sm-2 icon text-left">
    ...
    <script type="text/javascript">
         <?php if(get_session('licen')!=''){ ?>
              $('#import,#export,#authen_key,#webservice_demo,#data_warehouse').css('display','none');
               $('#datastandard,#statistic_importlog').removeClass("col-sm-4");
              $('#datastandard,#statistic_importlog').addClass("col-sm-6");
         <?php } ?>
    </script>
</html>
