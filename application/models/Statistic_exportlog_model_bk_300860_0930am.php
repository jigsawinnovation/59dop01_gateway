...
class Statistic_exportlog_model extends CI_Model {
	...
	var $column_search = array('A.req_datetime','A.pid',"C.user_firstname",'B.wsrv_name','B.owner_org','A.log_status','A.log_note'); //set column field database for datatable searchable 
