...
class Statistic_importlog_model_bk_29082560_0246pm extends CI_Model {
...
*/
		...
		// 	 // dieArray($_POST);
		// 	if($col['name']!='') // if datatable send POST for search
		// 	{
		// 		// dieArray($col['name']);
		// 				$this->db_gateway->like($col['name'], $_POST['search']['value']);
